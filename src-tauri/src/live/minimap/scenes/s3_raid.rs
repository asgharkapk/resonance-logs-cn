...
const MECHANIC_BUFF_IDS: &[i32] = &[
    ...
    829304, 829305, 829306, 829307, 829308, 829309, 829316, 829318, 829323, 829324, 829326, 829327,
    829328, 829329, 829330, 829331, 829332, 829372, 829373, 829374,
];
...
const RELEVANT_MONSTER_IDS: &[i32] = &[103106, 103301, 103302, 103303, 103309, 103310, 103311];
